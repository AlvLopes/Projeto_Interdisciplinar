...
void imprimirPalco(int poltrona[]){
		...
		printf("\n\n\t   ____________________Palco____________________\n\n\n");
		for (i = 1; i < 31; i++) {
...
int main ()
{
	...
	char show [7] = "Pagode ao vivo!";
	char horario [6] = {49, 57, 58, 48, 48};
	int dia;


	int idade;
	char adulto, est, estPubli;
	...
	printf("\n\t\t\tLa Fiesta-Casa de Shows\n"
		   "\tSistema de Bilhetagem Eletronica do La Fiesta\n\n"
			"Seja bem-vindo(a) ao sistema de vendas de ingressos do La Fiesta.\n"
			"Leia atentamente as instrucoes abaixo para obter \na melhor experiencia na venda dos ingressos.\n\n"
			"*******INFORMACOES IMPORTANTES*******\n\n"
			"- Neste mes de setembro, estamos recebendo a companhia teatral Tetris,\n"
			" que fara apresentacoes da peca teatral Hamlet, todos os dias do mes, sempre as 19:00.\n\n"
			"- O ingresso individual custa R$ 30,60.\n\n"
			"- Tem direito a um desconto de 50% (cinquenta por cento) no valor do ingresso individual:\n"
